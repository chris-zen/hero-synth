...
pub fn freq_from_key(key: u8) -> f64 {
    440.0f64 * (2_f64).powf((key as f64 - 69.0) / 12.0)
}

pub fn key_from_freq(freq: f64) -> u8 {
    69 + (12.0 * (freq / 440.0).log2().round()) as u8
}

pub fn pitch_scale(octaves: f64, semitones: f64, detune: f64) -> f64 {
    (2_f64).powf((octaves * 1200.0 + semitones * 100.0 + detune) / 1200.0)
}
